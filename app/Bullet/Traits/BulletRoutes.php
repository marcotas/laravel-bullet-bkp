...
trait BulletRoutes
{
    ...
    protected $directory = 'Http/Controllers';
    protected $httpMethods;

    public function controllers($directory = null)
    {
    ...
    {
        $dirs = new \IteratorIterator(new \DirectoryIterator(app_path($this->directory)));
        $files = collect();
    ...
    {
        $namespace = str_replace('/', '\\', $this->directory);
        return 'App\\' . $namespace . '\\' . $controller;
    }
